  ...
  .controller('AboutCtrl', function ($scope, $timeout) {
    $scope.content = {
      ...
      paragraphs: [
        ...
        "<img src=\"../../assets/images/fam.jpg\" class=\"info-img\" />",

        "Outside of work, I enjoy spending time with my family. I'm an avid sports fan. I enjoy watching and attending games for all of the local sports teams, and cheering on my daughter in her swim competitions. On fall Saturdays, you can find me out on the golf course in Ann Arbor tailgating for Michigan football (Go Blue!).",
