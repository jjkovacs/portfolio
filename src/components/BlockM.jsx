// University of Michigan "Block M" logo, adapted from the public domain
// vector source: https://commons.wikimedia.org/wiki/File:Michigan_Wolverines_logo.svg
export default function BlockM({ className = "" }) {
  return (
    <svg
      viewBox="0 0 294.32812 212.39062"
      className={className}
      xmlns="http://www.w3.org/2000/svg"
      aria-label="University of Michigan Block M logo"
    >
